...
public class EurovisionLOD
{
    ...
    public void GetContests(Contest[] contests)
    {
    ...
    private void InsertDataToContests(Dictionary<string, string>[] data, Contest[] contests)
    {
    ...
    private void InsertDataToContestants(Dictionary<string, string>[] data, Contest[] contests)
    {
        foreach (Dictionary<string, string> row in data)
        {
